...
#include <realsense2_framos_camera/DeviceInfo.h>
#include "realsense2_framos_camera/Metadata.h"
...
namespace realsense2_framos_camera
{
    ...
    protected:
        ...
        bool getDeviceInfo(realsense2_framos_camera::DeviceInfo::Request& req,
